...
{
    public sealed class Unity2023OrNewerGVTCompatibilityPolicy : ITypeCompatibilityPolicy
    {

        public static readonly Unity2023OrNewerGVTCompatibilityPolicy Instance = new Unity2023OrNewerGVTCompatibilityPolicy();
